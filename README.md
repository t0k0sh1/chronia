...
This library includes comprehensive AI-optimized documentation in the [`docs/`](docs/) directory.
See [`docs/README.md`](docs/README.md) for a complete guide designed for AI agents.
