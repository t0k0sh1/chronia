...
tools: Bash, Glob, Grep, Read, Edit, Write, TodoWrite, BashOutput, mcp__GitHub__get_pull_request_reviews, mcp__GitHub__get_pull_request_comments, mcp__GitHub__list_pull_requests
model: sonnet
color: blue
---
