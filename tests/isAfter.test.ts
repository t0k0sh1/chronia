...
/**
 * Test Design for isAfter
 *
 * Function signature: isAfter(dateLeft: Date | number, dateRight: Date | number, options?: { unit?: 'year' | 'month' | 'day' | 'hour' | 'minute' | 'second' }): boolean
 *
 ...
 * - Returns false if dateLeft is before or equal to dateRight
 * - Returns false if either date is invalid
 */

describe("isAfter", () => {
  describe("Equivalence Class 1: Both valid Date objects (millisecond precision)", () => {
    it("should return true when first date is 1ms after second date", () => {
      // Arrange
    ...
    it("should return false when comparing same Date object", () => {
      ...
      // Act
      const result = isAfter(date, date);
  ...
  describe("Equivalence Class 2: Both valid timestamps", () => {
    ...
    it("should return false when first timestamp is earlier", () => {
      // Arrange
  ...
  describe("Equivalence Class 3: Mixed Date and timestamp", () => {
    it("should handle Date object vs timestamp", () => {
      ...
      // Act
      const result = isAfter(dateLeft, timestampRight);
    ...
    it("should handle timestamp vs Date object", () => {
      // Arrange
      const timestampLeft = new Date(2024, 0, 1, 12, 0, 0, 1).getTime();
      const dateRight = new Date(2024, 0, 1, 12, 0, 0, 0);

      // Act
      const result = isAfter(timestampLeft, dateRight);
  ...
  describe("Equivalence Class 7: Unit-based comparison - year", () => {
    it("should return true when first year is after second year", () => {
      // Arrange
      const dateLeft = new Date(2025, 0, 1);
      const dateRight = new Date(2024, 0, 1);

      // Act
      const result = isAfter(dateLeft, dateRight, { unit: "year" });

      // Assert
      expect(result).toBe(true);
    });

    it("should return false when first year is before second year", () => {
      // Arrange
  ...
  describe("Equivalence Class 7: Unit-based comparison - month", () => {
    it("should return true when first month is after second month", () => {
      // Arrange
      const dateLeft = new Date(2024, 1, 1);
      const dateRight = new Date(2024, 0, 1);

      // Act
      const result = isAfter(dateLeft, dateRight, { unit: "month" });

      // Assert
      expect(result).toBe(true);
    });

    it("should return false when first month is before second month", () => {
      // Arrange
      const dateLeft = new Date(2024, 0, 1);
  ...
  describe("Equivalence Class 7: Unit-based comparison - day", () => {
    it("should return true when first day is after second day", () => {
      // Arrange
      const dateLeft = new Date(2024, 0, 2, 0, 0, 0);
      const dateRight = new Date(2024, 0, 1, 23, 59, 59);

      // Act
      const result = isAfter(dateLeft, dateRight, { unit: "day" });

      // Assert
      expect(result).toBe(true);
    });

    it("should return false when first day is before second day", () => {
      // Arrange
  ...
  describe("Equivalence Class 7: Unit-based comparison - hour", () => {
    it("should return true when first hour is after second hour", () => {
      // Arrange
      const dateLeft = new Date(2024, 0, 1, 13, 0, 0);
      const dateRight = new Date(2024, 0, 1, 12, 59, 59);

      // Act
      const result = isAfter(dateLeft, dateRight, { unit: "hour" });

      // Assert
      expect(result).toBe(true);
    });

    it("should return false when first hour is before second hour", () => {
      // Arrange
  ...
  describe("Equivalence Class 7: Unit-based comparison - minute", () => {
    it("should return true when first minute is after second minute", () => {
      // Arrange
      const dateLeft = new Date(2024, 0, 1, 12, 1, 0);
      const dateRight = new Date(2024, 0, 1, 12, 0, 59);

      // Act
      const result = isAfter(dateLeft, dateRight, { unit: "minute" });

      // Assert
      expect(result).toBe(true);
    });

    it("should return false when first minute is before second minute", () => {
      // Arrange
  ...
  describe("Equivalence Class 7: Unit-based comparison - second", () => {
    it("should return true when first second is after second second", () => {
      // Arrange
      const dateLeft = new Date(2024, 0, 1, 12, 0, 1, 0);
      const dateRight = new Date(2024, 0, 1, 12, 0, 0, 999);

      // Act
      const result = isAfter(dateLeft, dateRight, { unit: "second" });

      // Assert
      expect(result).toBe(true);
    });

    it("should return false when first second is before second second", () => {
      // Arrange
    ...
    it("should ignore milliseconds when comparing seconds", () => {
      // Arrange
      const dateLeft = new Date(2024, 0, 1, 12, 0, 2);
      const dateRight = new Date(2024, 0, 1, 12, 0, 1);
  ...
  describe("Boundary Value Analysis: Edge Cases", () => {
    ...
    it("should handle leap year boundaries", () => {
      ...
      const dateRight = new Date(2024, 1, 29); // Feb 29, 2024 (leap year)

      // Act
      const result1 = isAfter(dateLeft, dateRight, { unit: "day" });
      const result2 = isAfter(dateRight, dateLeft, { unit: "day" });
    ...
    it("should handle year boundaries (millisecond precision)", () => {
      // Arrange
      const dateLeft = new Date(2025, 0, 1, 0, 0, 0); // Jan 1, 2025 00:00:00
      const dateRight = new Date(2024, 11, 31, 23, 59, 59); // Dec 31, 2024 23:59:59

      // Act
      const result1 = isAfter(dateLeft, dateRight);
      const result2 = isAfter(dateRight, dateLeft);
    ...
    it("should handle DST transitions", () => {
      ...
      // Act
      const result1 = isAfter(afterDST, beforeDST);
      const result2 = isAfter(beforeDST, afterDST);
    ...
    it("should handle negative years (BC dates)", () => {
      ...
      // Act
      const result1 = isAfter(date1, date2);
      const result2 = isAfter(date2, date1);

      // Assert
      expect(result1).toBe(true); // -100 is after -200
      expect(result2).toBe(false);
    });
  ...
  describe("Equivalence Class 4: Invalid first date + valid second date", () => {
    it("should return false when first date is Invalid Date", () => {
      ...
      // Act
      const result = isAfter(invalidDate, validDate);
    ...
    it("should return false when first date is NaN timestamp", () => {
      ...
      // Act
      const result = isAfter(invalidTimestamp, validDate);
    ...
    it("should return false when first date is Infinity", () => {
      ...
      // Act
      const result = isAfter(Infinity, validDate);
  ...
  describe("Equivalence Class 5: Valid first date + invalid second date", () => {
    it("should return false when second date is Invalid Date", () => {
      ...
      // Act
      const result = isAfter(validDate, invalidDate);
    ...
    it("should return false when second date is NaN timestamp", () => {
      ...
      // Act
      const result = isAfter(validDate, invalidTimestamp);
    ...
    it("should return false when second date is Infinity", () => {
      ...
      // Act
      const result = isAfter(validDate, Infinity);
  ...
  describe("Equivalence Class 6: Both dates invalid", () => {
    it("should return false when both dates are Invalid Date", () => {
      ...
      // Act
      const result = isAfter(invalidDate1, invalidDate2);
    ...
    it("should return false when both dates are Infinity/-Infinity", () => {
      // Arrange & Act
      const result = isAfter(Infinity, -Infinity);
  ...
  describe("Unit-based comparison with invalid inputs", () => {
    it("should return false when first date is invalid with year-based comparison", () => {
      ...
      // Act
      const result = isAfter(invalidDate, validDate, { unit: "year" });
    ...
    it("should return false when second date is invalid with month-based comparison", () => {
      ...
      // Act
      const result = isAfter(validDate, invalidDate, { unit: "month" });
    ...
    it("should return false when first date is NaN timestamp with day-based comparison", () => {
      ...
      // Act
      const result = isAfter(NaN, validDate, { unit: "day" });
    ...
    it("should return false when second date is NaN timestamp with hour-based comparison", () => {
      ...
      // Act
      const result = isAfter(validDate, NaN, { unit: "hour" });
    ...
    it("should return false when first date is Infinity with minute-based comparison", () => {
      ...
      // Act
      const result = isAfter(Infinity, validDate, { unit: "minute" });
    ...
    it("should return false when second date is -Infinity with second-based comparison", () => {
      ...
      // Act
      const result = isAfter(validDate, -Infinity, { unit: "second" });
    ...
    it("should return false when both dates are invalid with unit-based comparison", () => {
      ...
      // Act
      const result = isAfter(invalidDate1, invalidDate2, { unit: "day" });
